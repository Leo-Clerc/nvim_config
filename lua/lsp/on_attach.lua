return function(client, bufnr)
  ...
  keymap("<Leader>ld", "<CMD>lua vim.lsp.buf.definition()<CR>", "Go to definition")
  keymap("<Leader>tlr", "<CMD>lua require('telescope.builtin').lsp_references()<CR>", "Telescope for references")
  keymap("<Leader>li", "<CMD>lua vim.lsp.buf.implementation()<CR>", "Goto implementation")
  keymap("<Leader>ltd", "<CMD>lua vim.lsp.buf.type_definition()<CR>", "Type definition")
  keymap("<Leader>tls", "<CMD>lua require('telescope.builtin').lsp_document_symbols()<CR>", "Document symbols")
